---
title: Working with Seurat
vignette: >
  %\VignetteIndexEntry{Working with Seurat}
...
## Why "quantitative" trajectory inference?
...
## Trajectory inference using Treefit and Seurat
...
## Quantitative trajectory inference with Treefit

### Performing the Treefit analysis
...
fit.tree_like <- treefit::treefit(list(expression=star.tree_like),
                                  name="tree-like")
star.non_tree_like <- treefit::generate_2d_n_arms_star_data(500, 3, 0.8)
fit.non_tree_like <- treefit::treefit(list(expression=star.non_tree_like),
                                      name="non-tree-like")
plot(trapnell.fit, fit.tree_like, fit.non_tree_like)
```
...
tree-like data with the `fatness` 0.1. This estimate is reasonable in
light of the fact that the myoblast dataset in [Trapnell <i>el
